local
  ...
  Part3 = [
  silence(duration:0.2) duration(seconds:0.4 [[d f a d5]]) stretch(factor:1.2 [[d f a] [d f a#4]])
  ...
  Part3bis = [
  silence(duration:0.2) duration(seconds:0.4 [[d3 d2]]) stretch(factor:0.2 [[d3 d2]]) duration(seconds:0.4 [[g1 g2]]) stretch(factor:0.2 [[g1 g2]])
