...
{Browse {List.is {Echantillon [ [note(duration:1.0 instrument:none name:a octave:4 sharp:false) note(duration:1.0 instrument:none name:a octave:4 sharp:false)] ]}}}
